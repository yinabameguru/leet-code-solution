...
public class IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        IntersectionOfTwoLinkedLists mainClass = new IntersectionOfTwoLinkedLists();
        Solution solution = mainClass.new Solution();
        ListNode listNode = Helper.toLinkedList("[4,1,8,4,5]");
        ListNode listNode2 = Helper.toLinkedList("[5,6,1,8,4,5]");
        solution.getIntersectionNode(listNode, listNode2);
    }
